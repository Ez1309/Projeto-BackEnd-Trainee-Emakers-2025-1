...
public class RestExceptionHandler {
    ...
    @ExceptionHandler({ LivroDuplicadoException.class, EmailJaCadastradoException.class,
    ...
    public ResponseEntity<RestErrorMessage> handleNaoAutorizado(RuntimeException exception) {
        return criarRespostaErro(HttpStatus.UNAUTHORIZED, exception.getMessage());
    }


    @ExceptionHandler(MethodArgumentNotValidException.class)
    private ResponseEntity<List<RestErrorMessage>> handleMethodArgumentNotValid(
